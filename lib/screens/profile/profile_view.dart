        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children:[
                  TextFormField('Name',Icons.person_outline,profileController.nameController.value),
                  SizedBox(height: 10,),
                  TextFormField('Home Address',Icons.home_outlined,ProfileController().homecontroller.value),
                  SizedBox(height: 10,),
                  TextFormField('Business Address',Icons.card_travel,ProfileController().businesscontroller.value),
                SizedBox(height: 10,),
                  TextFormField('Shopping Center',Icons.shopping_cart,ProfileController().shopcontroller.value),
                  SizedBox(height: 10,),
